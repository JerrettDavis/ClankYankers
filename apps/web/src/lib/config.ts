...
export function createHostConfig(backplaneId: string): HostConfig {
  ...
  return {
    ...
    sshCertificatePath: null,
    sshHostKeyFingerprint: null,
    sshTrustedCaFingerprint: null,
    sshAllowAnyHostKey: false,
    sshUseKeyboardInteractive: false,
    remoteDaemonUrl: null,
    remoteAccessToken: null,
    remoteExecutorKind: 'process',
    remoteAllowInsecureTls: false,
    remoteDockerEndpoint: null,
    remoteDockerImage: null,
    enabled: true,
  }
}
